...
#define PS_MAX_SEND_PACKET_SIZE		128

/* PS - Max size of received packet (in bytes) */
#define PS_MAX_RECV_PACKET_SIZE		128
...
#define FESS_SEND_BUF_SIZE		512

/* FESS - Size of reception buffer (in bytes) */
#define FESS_RECV_BUF_SIZE		512

/* FESS - Size of FESS temporary buffers (in bytes) */
#define FESS_TEMP_BUF_SIZE		512
